...
void my_uECC_secp256r1_info()
{
	...
	printf("p=");
	dump_hex_mycrypto_2(_es256_curve->p, uECC_MAX_WORDS*8);
	printf("n=");
	dump_hex_mycrypto_2(_es256_curve->n, uECC_MAX_WORDS*8);
	printf("b=");
	dump_hex_mycrypto_2(_es256_curve->b, uECC_MAX_WORDS*8);
	printf("G=");
	dump_hex_mycrypto_2(_es256_curve->G, uECC_MAX_WORDS*8*2);
	printf("Gx=");
	dump_hex_mycrypto_2(_es256_curve->G, uECC_MAX_WORDS*8);
	printf("Gy=");
	dump_hex_mycrypto_2(_es256_curve->G+4, uECC_MAX_WORDS*8);
...
void dump_hex_mycrypto_2(uint8_t * buf, int size)
{
    int org_size=size;
    while(size--)
    {
...
//reter debug - end
    ...
    printf("solokey's k^-1 is\t" );
    dump_hex_mycrypto_2(k, num_n_words*8);
...
int uECC_sign(const uint8_t *private_key,
    ...
    uECC_word_t myk[uECC_MAX_WORDS]={0x0007000a};//reter debug
    ...
    uECC_vli_set(k, myk, uECC_MAX_WORDS);//reter debug
